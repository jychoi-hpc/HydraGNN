...
def objective(trial):
    ...
    trial_results.loc[trial_id] = [trial_id, hidden_dim, num_conv_layers, num_headlayers, dim_headlayers,
                                   model_type, validation_loss]
...
if __name__ == "__main__":
    ...
    trial_results = pd.DataFrame(
        columns=['Trial_ID', 'Hidden_Dim', 'Num_Conv_Layers', 'Num_Headlayers', 'Dim_Headlayers', 'Model_Type',
                 'Validation_Loss'])
